...
function PeoplePanel({ people, error, onChanged }: { people: PersonDto[]; error: string | null; onChanged: () => Promise<void> }) {
  ...
  return <div className="mt-4 space-y-4">
    <Card>
      ...
      <p className="mt-2 text-sm leading-5 text-ink-soft">Children’s exact names in an event title or description automatically add them to that event. Parent names never do. Give children distinct names so matching stays unambiguous.</p>
    </Card>
